...
func! s:clr(fg, bg, ...)
  let l:fg = g:poimandres#palette[a:fg]
  let l:bg = g:poimandres#palette[a:bg]
...
let g:airline#themes#poimandres#palette = {
\   'normal': s:color_map(
\       ['bg', 'purple'],
\       ['fg', 'comment'],
\       ['fg', 'selection'],
...
if get(g:, 'airline#extensions#tabline#enabled', 0)
  let g:airline#themes#poimandres#palette.tabline = {
...
if exists('g:loaded_ctrlp')
  let g:airline#themes#poimandres#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
        \ s:clr('fg', 'selection'),
        \ s:clr('fg', 'comment'),
        \ s:clr('fg', 'purple'),
        \)
