...
let g:poimandres#palette.brightYellow = ['#fffac2', 123]
let g:poimandres#palette.brightMint = ['#5de4c7', 123]
let g:poimandres#palette.lowerMint = ['#5fb3a1', 123]
let g:poimandres#palette.blueishGreen = ['#42675a', 123]
let g:poimandres#palette.lowerBlue = ['#89ddff', 123]
let g:poimandres#palette.lightBlue = ['#add7ff', 123]
let g:poimandres#palette.desaturatedBlue = ['#91b4d5', 123]
let g:poimandres#palette.hotRed = ['#d0679d', 123]
let g:poimandres#palette.pink = ['#fcc5e9', 123]
let g:poimandres#palette.brighterPink = ['#fae4fc', 123]
let g:poimandres#palette.gray = ['#a6accd', 123]
let g:poimandres#palette.darkerGray = ['#767c9d', 123]
let g:poimandres#palette.bluishGray = ['#506477', 123]
let g:poimandres#palette.bluishGrayBrighter = ['#7390AA', 123]
let g:poimandres#palette.offWhite = ['#e4f0fb', 123]
